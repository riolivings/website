...
const PortfolioItem = ({ item, action }) => (
  <Motion initial="hidden" animate={"visible"} variants={animations.u2b} className="w-full lg:w-[25em] relative overflow-hidden border border-stone-300" onClick={action}>
