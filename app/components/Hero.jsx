...
export default function Hero() {
  ...
  return (
    <div className="flex basis-1/2 items-center p-6 lg:p-16 relative h-[80vh] lg:h-screen overflow-hidden">
      {/* <ParticlesComponent /> */}
      ...
      <div className="w-full lg:w-1/2 relative z-10">
        ...
        <motion.h1 initial="hidden" whileInView="visible" variants={animations.r2l} className="text-primary text-5xl lg:text-6xl font-bold tracking-wider leading-[1.1] lg:leading-[1.1]">Building <br /></motion.h1>
        <motion.h1 initial="hidden" whileInView="visible" variants={animations.l2r} className="text-primary text-5xl lg:text-6xl font-bold tracking-wider leading-[1.1] lg:leading-[1.1]">Happiness<br /></motion.h1>

        <motion.div initial="hidden" whileInView="visible" variants={animations.r2l} className="mt-3 flex flex-col gap-3 items-start">
          <p className="lg:text-lg text-white tracking-[2px] leading-[1.5] lg:leading-[1.8]">Rio Livings upholds a tradition of unparalleled excellence and integrity, delivering homes crafted for a lifetime of comfort and style</p>
